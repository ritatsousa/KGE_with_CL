...
class ComplEx(Model):
	...
	def predict_def(self):
		...
		predict_h_e1 = tf.nn.embedding_lookup(self.ent1_embeddings, self.predict_h)
		predict_t_e1 = tf.nn.embedding_lookup(self.ent1_embeddings, self.predict_t)
		predict_r_e1 = tf.nn.embedding_lookup(self.rel1_embeddings, self.predict_r)
		predict_h_e2 = tf.nn.embedding_lookup(self.ent2_embeddings, self.predict_h)
		predict_t_e2 = tf.nn.embedding_lookup(self.ent2_embeddings, self.predict_t)
		predict_r_e2 = tf.nn.embedding_lookup(self.rel2_embeddings, self.predict_r)
